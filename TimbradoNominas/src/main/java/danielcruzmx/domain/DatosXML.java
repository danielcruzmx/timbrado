...
public class DatosXML {
	...
	// percepcion 
	List <ConceptoPercepcion> percepciones;
	
	// deducciones nomina
	private BigDecimal totalOtrasDeducciones;
	private BigDecimal totalImpuestosRetenidos;
	// deduccion
	List <ConceptoDeduccion> deducciones;

	// otros pagos nomina
	List <ConceptoOtrosPagos> otrosPagos;
	...
	public List <ConceptoPercepcion> getPercepciones() {
		return percepciones;
	}

	public void setPercepciones(List <ConceptoPercepcion> percepciones) {
	...
	public List <ConceptoOtrosPagos> getOtrosPagos() {
		return otrosPagos;
	}

	public void setOtrosPagos(List <ConceptoOtrosPagos> otrosPagos) {
