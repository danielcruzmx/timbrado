...
@NamedQueries( {@NamedQuery(name="TnComprobanteDig.findAll", query="SELECT t FROM TnComprobanteDig t ") })
@NamedNativeQueries( { @NamedNativeQuery(name="TnComprobanteDig.findByNomina", query="" + ""
		                        ...
		                        resultClass=TnComprobanteDig.class
		           )})
public class TnComprobanteDig implements Serializable {
	private static final long serialVersionUID = 1L;
	public final static String FIND_NOMINA = "TnComprobanteDig.findByNomina";
	
	@EmbeddedId
	private TnComprobanteDigPK id;
	...
	public TnComprobanteDigPK getId() {
		return this.id;
	}

	public void setId(TnComprobanteDigPK id) {
		this.id = id;
	}
